...
//    let slide_wrapper = document.getElementsByClassName("slider");

//    let slide_item = document.createElement("div");
//    slide_item.setAttribute("class", "slide-item");

//    tree.appendChild(slide_item).

//    slide_wrapper.appendChild(slide_item);
...
// document.getElementById("main").appendChild(main_slider);

// v4
// var tree = document.createDocumentFragment();

// let main_wrapper = document.getElementsByClassNamei("slider");

// let slide_item = document.createElement("div");
// link.setAttribute("class", "slide-item");
